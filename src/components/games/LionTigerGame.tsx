  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto p-4 pb-20">
        ...
        <div
          className="relative rounded-2xl overflow-hidden mb-4 py-8"
        ...
        <AnimatePresence>
          {phase === "result" && (
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="text-center mb-4 space-y-2">
              ...
              {winAmount > 0 && <p className="text-2xl font-black text-yellow-300">+{winAmount} 💎</p>}
          ...
          <div className="mb-3">
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-[10px] text-white/50 font-bold">
                الرصيد: <CurrencyIcon type="gold" size="xs" /> {balance.toLocaleString()}
              </span>
            </div>
        ...
        {phase === "betting" && (
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #f5c842, #e6a817, #f5c842)",
              boxShadow: "0 0 30px rgba(245,200,66,0.4)",
            }}
          >
            {choice
              ? `راهن ${betAmount} على ${choice === "lion" ? "🦁" : choice === "tiger" ? "🐯" : "🤝"}`
              : "اختر رهانك"}
          </button>
        )}
